	...
	function feedback( $result = null ) {
		...
		<?php elseif ( isset( $_GET['added'] ) ) : ?>
			...
			<div id="message" class="updated fade">
				<p>
					<?php esc_html_e( 'Network created.', 'wp-multi-network' ); ?><br />
	...
	function add_network_page() {
		...
		<div class="wrap">
			...
			<div id="col-container">
				...
				<p><?php printf( esc_html__( 'Note: Default network options from %s will be copied to the the new network.', 'wp-multi-network' ), network_home_url() ); ?>.</p>
